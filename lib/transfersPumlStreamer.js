...
const transfers2PumlStream = (transactions, transfers, participants, network, hideFooter, hideBalances) => {
    networkCurrency = (0, tx2umlTypes_1.setNetworkCurrency)(network);
    const pumlStream = new stream_1.Readable({
        read() { },
    });
    if (transactions.length > 1) {
        (0, exports.multiTransfers2PumlStream)(pumlStream, transactions, transfers, participants, hideFooter, hideBalances);
    }
    else {
        (0, exports.singleTransfer2PumlStream)(pumlStream, transactions[0], transfers[0], participants, hideFooter, hideBalances);
    }
    return pumlStream;
};
exports.transfers2PumlStream = transfers2PumlStream;
const multiTransfers2PumlStream = (pumlStream, transactions, transfers, participants, hideFooter, hideBalances) => {
...
const singleTransfer2PumlStream = (pumlStream, transaction, transfers, participants, hideFooter, hideBalances) => {
