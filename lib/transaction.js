...
class TransactionManager {
    ...
    async getContractsFromTraces(transactionsTraces, configFilename, abiFilename, network = "mainnet", mappedSource = []) {
    ...
    async configOverrides(contracts, filename) {
        ...
        for (const [contractAddress, config] of Object.entries(configs)) {
            const address = (0, address_1.getAddress)(contractAddress);
