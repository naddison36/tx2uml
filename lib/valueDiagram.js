...
const generateValueDiagram = async (hashes, options) => {
    ...
    const pumlStream = (0, transfersPumlStreamer_1.transfers2PumlStream)(transactions, transactionTransfers, participants, options.chain, options.hideFooter, options.hideBalances);
