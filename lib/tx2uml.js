...
program
    ...
    .addOption(new commander_1.Option("-c, --chain <value>", "blockchain explorer to get contract source code from. `none` will not get any source code. `custom` will use the `explorerUrl` option.")
