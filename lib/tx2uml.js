...
program.configureOutput({
    outputError: (str, write) => write(str.replace("required option '-k, --etherscanKey <value>' not specified", "required option '-k, --etherscanKey <value>' not specified and EXPLORER_API_KEY environment variable not set")),
});
program
