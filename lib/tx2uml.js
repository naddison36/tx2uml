...
const tx2uml = async () => {
    ...
    const etherscanClient = new EtherscanClient_1.default(program.etherscanKey, chain);
    ...
    transaction_1.TransactionManager.parseTraceDepths(transactionTracesUnfiltered, contracts);
    transaction_1.TransactionManager.parseTraceParams(transactionTracesUnfiltered, contracts);
    const [transactionTraces, usedContracts] = transaction_1.TransactionManager.filterTransactionTraces(transactionTracesUnfiltered, contracts, program);
