...
const OpenEthereumClient_1 = __importDefault(require("./OpenEthereumClient"));
const EtherscanClient_1 = __importDefault(require("./EtherscanClient"));
...
const tx2uml = async () => {
    ...
    const nodeClient = new OpenEthereumClient_1.default(url);
    const etherscanClient = new EtherscanClient_1.default();
    const txManager = new transaction_1.TransactionManager(nodeClient, etherscanClient);
    let pumlStream;
    let transactions = [];
