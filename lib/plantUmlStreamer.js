...
exports.streamPlantUml = (transactions, options = {}) => {
    const pumlStream = new stream_1.Readable({
        read() { }
    });
    if (Array.isArray(transactions)) {
        exports.streamMultiTxsPlantUml(pumlStream, transactions, options);
    }
    else {
        exports.streamSingleTxPlantUml(pumlStream, transactions, options);
    }
    return pumlStream;
};
exports.streamMultiTxsPlantUml = (pumlStream, transactions, options = {}) => {
    ...
    for (const transaction of transactions) {
        ...
        exports.writeParticipants(pumlStream, transaction.contracts);
...
exports.streamSingleTxPlantUml = (pumlStream, transaction, options = {}) => {
