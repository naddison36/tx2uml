...
exports.streamPlantUml = (transactions, contracts, options = {}) => {
    const pumlStream = new stream_1.Readable({
        read() { }
    });
    if (Array.isArray(transactions)) {
        exports.streamMultiTxsPlantUml(pumlStream, transactions, contracts, options);
    }
    else {
        exports.streamSingleTxPlantUml(pumlStream, transactions, contracts, options);
    }
    return pumlStream;
};
exports.streamMultiTxsPlantUml = (pumlStream, transactions, contracts, options = {}) => {
...
exports.streamSingleTxPlantUml = (pumlStream, transaction, contracts, options = {}) => {
