        ...
        try {
            ...
            for (const trace of traceResponses) {
                ...
                const from = type === transaction_1.MessageType.Selfdestruct
                    ? (_f = trace.action) === null || _f === void 0 ? void 0 : _f.address : (_g = trace.action) === null || _g === void 0 ? void 0 : _g.from;
                ...
                const inputs = type === transaction_1.MessageType.Create
                    ? (_h = trace.action) === null || _h === void 0 ? void 0 : _h.init : (_j = trace.action) === null || _j === void 0 ? void 0 : _j.input;
                const outputs = type === transaction_1.MessageType.Create
                    ? (_k = trace.result) === null || _k === void 0 ? void 0 : _k.code : (_l = trace.result) === null || _l === void 0 ? void 0 : _l.output;
                const newTrace = {
                    id: id++,
                    type,
                    from,
                    delegatedFrom,
                    to,
                    value: ((_m = trace.action) === null || _m === void 0 ? void 0 : _m.value) ? convertBigNumber((_o = trace.action) === null || _o === void 0 ? void 0 : _o.value)
