                ...
                if ("0xddf252ad1be2c89b69c2b068fc378daa952ba7f163c4a11628f55a4df523b3ef" ===
                    ...
                    if (log.topics.length === 3) {
                        transferEvents.push({
                            ...
                            event: "Transfer",
                            type: log.topics[1] === ethers_1.constants.HashZero
                                ? tx2umlTypes_1.TransferType.Mint
                                : log.topics[2] === ethers_1.constants.HashZero
...
const parseAddress = (log, topicIndex) => {
    return log.topics[topicIndex] === ethers_1.constants.HashZero
        ? (0, utils_1.getAddress)(log.address)
        : (0, utils_1.getAddress)((0, utils_1.hexDataSlice)(log.topics[topicIndex], 12));
};
