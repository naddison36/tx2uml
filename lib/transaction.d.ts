...
import { Contracts, Participants, SourceMap, Trace, TransactionDetails, Transfer } from "./types/tx2umlTypes";
export declare class TransactionManager {
    ...
    getContractsFromTraces(transactionsTraces: Trace[][], configFilename?: string, abiFilename?: string, network?: string, mappedSource?: SourceMap[]): Promise<Contracts>;
    ...
    setTokenAttributes(contracts: Contracts, network: string): Promise<void>;
    getTransferParticipants(transactionsTransfers: Transfer[][], block: number, network: string, configFilename?: string, mapSource?: SourceMap[]): Promise<Participants>;
