...
export declare const streamPlantUml: (transactions: TransactionInfo | TransactionInfo[], options?: PumlGenerationOptions) => Readable;
export declare const streamMultiTxsPlantUml: (pumlStream: Readable, transactions: TransactionInfo[], options?: PumlGenerationOptions) => Readable;
export declare const streamSingleTxPlantUml: (pumlStream: Readable, transaction: TransactionInfo, options?: PumlGenerationOptions) => Readable;
